...
* ServerStatus-wxlost版是一个酷炫高逼格的云探针、云监控、服务器云监控、多服务器探针~，该云监控（云探针）是ServerStatus（ https://github.com/tenyue/ServerStatus ）项目的优化/修改版。
...
* 2018.03.22, 检查了一边脚本.修改探针为直接下载`原作者最新版`

# 安装教程：     

执行下面的代码下载并运行脚本。
``` bash
wget -O status.sh https://raw.githubusercontent.com/wxlost/shell/master/ServerStatus/status.sh && chmod +x status.sh
```
